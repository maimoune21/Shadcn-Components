...
function AppSidebar(props) {
  return (
    <Sidebar className="mt-11 rounded-none! !h-[calc(100svh-var(--header-height))]" {...props}>
...
export { AppSidebar, SiteHeader, NavMain, NavProjects, NavSecondary, NavUser, SearchForm }
